---
title: "02.K8S架构详解"
description: "上图包含了K8S中的所有组件，我们把K8S集群分为两个部分，即`Master`节点（主结点）和`Node`节点（工作结点），其中主节点运行着控制平面组件`Control Plane Components`，工作结点运行着必要的`Kubelet`和`Kube-proxy`组件。"
date: 2023-10-05
tags: ["K8S", "分布式", "职场"]
---
# 02.K8S架构详解
...
![](https://cdn.nlark.com/yuque/0/2023/png/26372139/1697769214856-32a809fc-1d7d-41f2-b025-1306436d4522.png)
...
工作结点：因为scheduler在调度pod的时候有自动调动策略，通常如果某个node结点失效，会自动将pod部署在其他node上，所以node结点我们无需额外处理，只要集群拥有足够多的node结点，运行情况就会很稳定
...
![](https://cdn.nlark.com/yuque/0/2023/png/26372139/1697794530279-82a6bf65-f140-48dd-b863-d6cefa32bd38.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/26372139/1697797080390-b82b6a31-8f7d-49fc-a346-d78056b0269b.png)
...
![](https://cdn.nlark.com/yuque/0/2023/png/26372139/1697792108252-24b9609e-cec5-4c25-ab6e-52f1274f3327.png)
...
《每天十分钟，轻松入门K8S》的第二篇**02.女朋友都能看懂的K8S架构详解** 到这里就结束了，感谢您看到这里。
